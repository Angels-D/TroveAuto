...
Memory::Offsets Game::World::offsets = {0x1097504, 0x0};
...
Memory::Offsets Game::Player::offsets = {0x1097680, 0x0};
...
Memory::Offsets Game::Player::Fish::offsets = {0x106D24C, 0x68, 0x0};
