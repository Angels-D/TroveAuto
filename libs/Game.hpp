...
Memory::Offsets Game::World::offsets = {0x10984B0, 0x0};
...
Memory::Offsets Game::Player::offsets = {0x1098438, 0x0};
...
Memory::Offsets Game::Player::Fish::offsets = {0x10947A4, 0x68, 0x0};
