...
Memory::Offsets Game::World::offsets = {0x11F74BC, 0x0};
...
Memory::Offsets Game::World::Player::offsets = {0xFC, 0x00};
Memory::Offsets Game::World::Player::Data::nameOffsets = {0x1D0, 0x0};
Memory::Offsets Game::World::Player::Data::xOffsets = {0xC4, 0x04, 0x80};
...
Memory::Offsets Game::Player::Fish::offsets = {0x11CB76C, 0x68, 0x0};
