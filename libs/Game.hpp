...
Memory::Offsets Game::World::offsets = {0x11F8514, 0x0};
...
Memory::Offsets Game::Player::offsets = {0x11FAD74, 0x0};
...
Memory::Offsets Game::Player::Fish::offsets = {0x11F6C6C, 0x68, 0x0};
